...
export class ChoupalProvider {
  ...
  getChoupal(filter_distance) {
    var user_id = this.api.userData.ID;
    //http://205.147.100.82/agriboloapiv2/api/web/index.php?r=v1/mandi/all&page=2&state_id=12
  	var paramCond ={filter_distance:filter_distance,lat:this.userLatLong.latitude,longe:this.userLatLong.longitude,user_id:user_id};
